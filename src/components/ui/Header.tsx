        ...
        <nav role='navigator' className='flex sm:pl-10 md:py-6 max-sm:py-3 max-sm:none border-b md:px-10'>
            <ul className='flex justify-between w-[100vw] text-lg' id='desktop-nav'>
                ...
                <div className="flex font-thin">
                    ...
                    <li>
                        <a href='#skills' className='hover:text-yellow-500 ml-4'>Skills</a>
                    </li>
                    <li>
                        <a href='#projects' className='hover:text-yellow-500 ml-4'>Projects</a>
                    </li>
                    <li className='mx-4'>
            ...
            <div id='mobile-nav' className='w-[100vw]'>
               <div className="flex justify-between px-5">
                ...
                <ul id='mobile-menu' onClick={closeMenu} className='z-[1000] fixed bg-white right-0 top-0 left-0 bottom-0 font-thin flex flex-col h-[100vh] justify-center items-center'>
                    <li>
                        <a href='#about' className='hover:text-yellow-500 text-lg my-6'>About</a>
                    </li>
                    <li>
                        <a href='#skills' className='hover:text-yellow-500 text-lg my-6'>Skills</a>
                    </li>
                    <li>
                        <a href='#projects' className='hover:text-yellow-500 text-lg my-6'>Projects</a>
                    </li>
                    <li className='mt-6'>
